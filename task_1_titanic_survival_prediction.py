# -*- coding: utf-8 -*-
"""Task 1_Titanic_Survival_prediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15I67B8T4afAQXDmyd6O3XygdpIjGaxND
...
import numpy as np   # providing support for arrays, matrices, and a wide range of mathematical functions.
import pandas as pd  # used for data manipulation and analysis, offering data structures like DataFrames for handling structured data.
import matplotlib.pyplot as plt  # used for creating static, interactive, and animated visualizations in Python.
import seaborn as sns           #used for making attractive and informative statistical graphics.
...
from sklearn.linear_model import LogisticRegression   #  Logistic Regression is a machine learning algorithm used for binary classification tasks.
from sklearn.metrics import accuracy_score       #  This function is used to calculate the accuracy of a classification model, comparing the predicted and true labels.
...
ngrok.set_auth_token("2iy3DEhw7rAsrlJseMegAoTqHSg_3fQPoTvRvr1yjrc31h7Em")
